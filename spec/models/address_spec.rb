...
describe Address do
  ...
  it { is_expected.to validate_presence_of(:street_1).with_message("can't be blank") }
  it { is_expected.to validate_presence_of(:city).with_message("can't be blank") }
  it { is_expected.to validate_presence_of(:state_province).with_message("can't be blank") }
  it { is_expected.to validate_presence_of(:postal_code).with_message("can't be blank") }
  it { is_expected.to validate_presence_of(:country_code).with_message("can't be blank") }
