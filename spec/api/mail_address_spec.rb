...
describe Ohana::API do
  ...
  describe 'PATCH /api/locations/:location/mail_address' do
    ...
    it 'requires mail_address street' do
      ...
      expect(json['message']).to include "Street can't be blank for Mail Address"
    end
    ...
    it 'requires mail_address city' do
      ...
      expect(response.status).to eq(400)
      expect(json['message']).to include "City can't be blank for Mail Address"
    end
    ...
    it 'requires mail_address state' do
      ...
      expect(response.status).to eq(400)
      expect(json['message']).to include "State can't be blank for Mail Address"
    end
    ...
    it 'requires mail_address zip' do
      ...
      expect(response.status).to eq(400)
      expect(json['message']).to include "Zip can't be blank for Mail Address"
    end
